<footer class="d-flex flex-wrap justify-content-center align-items-center py-4 mt-4">
    <div class="col-md-4 d-flex align-items-center justify-content-center">
        ...
        <ul class="nav col-md-4 list-unstyled d-flex align-items-center justify-content-center">
            ...
            <li class="ms-3"><a class="text-body-secondary" href="https://www.linkedin.com/in/jackrhowarth"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 50 50" width="24" height="24">
                        <path
